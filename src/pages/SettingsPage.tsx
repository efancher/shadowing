    ...
    <div className="page">
      ...
      <section className="card settings-card">
        ...
        {!summary ? (
          ...
          <dl className="storage-grid">
            ...
            <div><dt>App media</dt><dd>{formatBytes(summary.mediaBytes)}</dd></div>
            <div>
              <dt>Origin usage</dt>
              <dd>{estimatedUsage?.usage === undefined ? "Unavailable" : formatBytes(estimatedUsage.usage)}</dd>
            </div>
          </dl>
        )}
        {estimatedUsage?.quota !== undefined && (
          <p className="muted">Browser-reported quota: approximately {formatBytes(estimatedUsage.quota)}.</p>
        )}
      </section>
      ...
      <section className="card settings-card">
        ...
        <p>
          ...
          <strong> Audio files are not included in this milestone.</strong>
        </p>
