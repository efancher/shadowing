...
Rich, Pydantic, jsonschema, and the yt-dlp Python package.
...
Bulk mining uses aligned English subtitles when available and skips cues that
were already saved from the same original timestamps.
